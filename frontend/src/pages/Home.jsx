      ...
      <div className="w-full flex justify-center mt-6 md:mt-10">
        <div className="w-full max-w-6xl bg-black/50  border border-gray-700 bg-opacity-70 backdrop-blur-md p-6 md:p-8 rounded-xl shadow-lg">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 p-4 md:p-8 bg-gray-800 rounded-xl shadow-md border border-gray-700 ">
            ...
            <div className="w-full md:w-1/2 flex flex-col items-center justify-center gap-5">
              <img
                src={myPhoto}
                alt="Pratham Raj"
                className="w-40 h-40 md:w-80 md:h-80 rounded-full border-4 border-gray-500 shadow-lg transition-transform duration-300 hover:scale-105  items-center justify-center"

              />
              <div className="flex  items-center justify-center gap-4">
                <a href="https://github.com/GeekyPratham" target="_blank" rel="noopener noreferrer">
                  <FaGithub className="text-2xl hover:text-gray-400" />
                </a>
                <a href="https://www.linkedin.com/in/pratham-raj-890625257/" target="_blank" rel="noopener noreferrer">
            ...
            <div className="w-full md:w-2/3 text-gray-300 space-y-4 text-center md:text-left">
              ...
              <p className="text-sm md:text-lg leading-relaxed">
                A passionate and driven tech enthusiast with a strong desire to push boundaries in the world of software development. My journey in tech began with a fascination for solving complex problems and crafting impactful solutions. I thrive in an environment that challenges me to grow and innovate, and I'm constantly motivated to learn new technologies to build meaningful experiences.
                <br /><br />
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-8 mt-8 md:mt-10 p-4 md:p-6 bg-gray-800 rounded-xl shadow-md border border-gray-700">
            ...
            <Count text="Years Experience" count="1" />
