...
const skills = [
    ...
    { name: "SQL", icon: <SiMysql className="text-blue-500" /> }, // Changed from MongoDB to MySQL for SQL
    { name: "HTML 5", icon: <FaHtml5 className="text-orange-500" /> },
    { name: "CSS 3", icon: <FaCss3Alt className="text-blue-500" /> },
    { name: "React", icon: <FaReact className="text-cyan-400" /> },
    { name: "Node.js", icon: <FaNodeJs className="text-green-500" /> },
    { name: "Express.js", icon: <SiExpress className="text-gray-400" /> }, // Updated Express icon
    { name: "Django", icon: <SiDjango className="text-green-500" /> },
    { name: "Tailwind CSS", icon: <SiTailwindcss className="text-blue-400" /> },
    { name: "MongoDB", icon: <SiMongodb className="text-green-400" /> }, // Changed to general MongoDB instead of Atlas
    ...
    return (
        <div className="w-screen h-screen overflow-y-auto bg-gradient-to-b from-black via-gray-900 to-gray-800 px-6 py-6 text-white">
            ...
            <div className="w-full max-w-6xl mx-auto bg-black/50 backdrop-blur-lg p-5 rounded-xl shadow-xl border border-gray-700 flex flex-col sm:flex-row gap-5 min-h-[80vh]">
                ...
                {/* Left Part */}
                <div className="flex flex-col gap-5 justify-center items-center sm:items-start w-full sm:w-1/2 h-full p-5 rounded-lg mt-15">
    ...
    return (
        <div className="flex flex-col gap-5 justify-center items-start w-full rounded-lg">
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-3 
             rounded-lg bg-gray-900/80 border border-gray-700 
             shadow-lg backdrop-blur-lg p-6 
             h-[300px] overflow-y-auto">
                <div className="p-2 w-full overflow-auto bg-gray-900/80 border border-gray-700 shadow-lg rounded-lg backdrop-blur-lg">
                    <h2 className="text-l font-bold text-green-400 sm:text-left">B-Tech : 2022-2026</h2>
                    <p>Heritage Institute of Technology</p>
                    <h5>SGPA - 9.3</h5>
                </div>
                <div className="p-2 w-full overflow-auto bg-gray-900/80 border border-gray-700 shadow-lg rounded-lg backdrop-blur-lg">
                    <h2 className="text-l font-bold text-green-400 sm:text-left">12th(PCM) : 2019-2021</h2>
                    <p>Millia Convent English School, Rambagh, Purnea</p>
                    <h5>Percentage - 74.5</h5>
                </div>
                <div className="p-2 w-full overflow-auto bg-gray-900/80 border border-gray-700 shadow-lg rounded-lg backdrop-blur-lg">
                    <h2 className="text-l font-bold text-green-400 sm:text-left">10th : 2019</h2>
...
function Experience(){
    return (
        <div className="flex flex-col gap-5 justify-center items-start w-full rounded-lg">
            ...
            <div className="w-full  gap-3 rounded-lg bg-gray-900/80 border border-gray-700 shadow-lg backdrop-blur-lg p-6 h-[300px] overflow-y-auto">
                <div className="p-2 w-full bg-gray-900/80 border border-gray-700 shadow-lg rounded-lg backdrop-blur-lg">
                    <h2 className="text-l font-bold text-green-400 sm:text-left">
        ...
        <div className="flex flex-col gap-5 justify-center items-start w-full rounded-lg">
            ...
            <div className="w-full gap-3 rounded-lg bg-gray-900/80 border border-gray-700 shadow-lg backdrop-blur-lg p-6 h-[300px] overflow-y-auto">
                ...
                <div className="flex items-center gap-2">
                        <span className="font-semibold">Name:</span> <span>Pratham Raj</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <FaPhone className="text-green-400" /> <span>7050861440</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <FaEnvelope className="text-red-400" /> 
                        <a href="mailto:kprathamraj2021@gmail.com" className="hover:underline">kprathamraj2021@gmail.com</a>
                    </div>
                    <div className="flex items-center gap-2">
                        <FaGithub className="text-gray-400" /> 
                        <a href="https://github.com/GeekyPratham" target="_blank" rel="noopener noreferrer" className="hover:underline">github.com/GeekyPratham</a>
                    </div>
                    <div className="flex items-center gap-2">
                        <FaLinkedin className="text-blue-400" /> 
                        <a href="https://www.linkedin.com/in/pratham-raj-890625257/" target="_blank" rel="noopener noreferrer" className="hover:underline">LinkedIn Profile</a>
                    </div>
                    <div className="flex items-center gap-2">
                        {/* <FaGeeksforGeeks className="text-blue-400" />  */}
                        <a href="https://www.geeksforgeeks.org/user/kprathamiemf/" rel="noopener noreferrer" className="hover:underline">GFG </a>
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="font-semibold">Freelance:</span> <span className="text-green-400">Available</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="font-semibold">Languages:</span> <span>Hindi, English</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="font-semibold">Hobbies:</span> <span>Cricket, Badminton</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="font-semibold">Location:</span> <span>Kolkata, India</span>
                    </div>
                </div>
            </div>
        </div>
...
function Skills(){
    ...
    return (
        <div className="flex flex-col gap-5 justify-center items-start w-full rounded-lg px-4 md:px-8">
            ...
            {/* Skills Grid */}
            <div className="w-full rounded-lg bg-gray-900/80 border border-gray-700 shadow-lg backdrop-blur-lg p-6 h-[300px] overflow-y-auto">
...
function Courses(){
    return (
        <div className="flex flex-col gap-5 justify-center items-start w-full rounded-lg">
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-3 rounded-lg bg-gray-900/80 border border-gray-700 shadow-lg backdrop-blur-lg p-6 min-h-[300px] overflow-y-auto">
                <div className="p-2 w-full max-h-[200px] bg-gray-900/80 border border-gray-700 shadow-lg rounded-lg backdrop-blur-lg overflow-auto">
                    <h2 className="text-l font-bold text-green-400 sm:text-left">DSA - Nov 10, 2023</h2>
                ...
                <div className="p-2 w-full max-h-[200px] bg-gray-900/80 border border-gray-700 shadow-lg rounded-lg backdrop-blur-lg overflow-auto">
                    <h2 className="text-l font-bold text-green-400 sm:text-left">Postman API Fundamentals Student Expert - 9 Feb 2025</h2>
